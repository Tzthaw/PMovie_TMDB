package com.mmgoogleexpert.ptut.pmovie_tmdb.components
...
import com.mmgoogleexpert.ptut.pmovie_tmdb.PMovieApplication
...
object ImageRequester {
    ...
    init {
        val context = PMovieApplication.instance
